...
def load_feature(frame_names, union_box_feature, path='/network_space/server126/shared/xuzhu/CSA/clean_version/data/action-genome/AG_detection_results_refine', load_feat=True):
    """
...
def assign_label_to_proposals_by_dict_for_video(dets, feats, is_train, gt_annotation, dict_path='/network_space/server126/shared/xuzhu/CSA/clean_version/data/action-genome/annotations/weak', pseudo_way=0):
...
def convert_data(is_train, base_feat_list, video_people_det, video_people_feat, video_object_det, video_object_feat, \
    ...
    if union_box_feature:
        ...
        imgs_paths = [os.path.join('/network_space/server126/shared/xuzhu/CSA/clean_version/data/action-genome/frames', f) for f in frame_names]
