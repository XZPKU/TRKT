...
class ObjectClassifier(nn.Module):
    ...
    def __init__(self, mode='sgdet', obj_classes=None, is_wks=True):
        ...
        embed_vecs = obj_edge_vectors(obj_classes[1:], wv_type='glove.6B', wv_dir='/home/wangguan/CSA', wv_dim=200)
...
class STTran(nn.Module):
    ...
    def __init__(self, mode='sgdet',
        ...
        embed_vecs = obj_edge_vectors(obj_classes, wv_type='glove.6B', wv_dir='/home/wangguan/CSA', wv_dim=200)
