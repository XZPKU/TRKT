...
from engine import evaluate, evaluate_refinements, train_one_epoch, train_one_epoch_refine_coco, evaluate_refinements_specific_layer, \
    evaluate_detections, evaluate_seed_proposal, evaluate_seed_proposal_detections, evaluate_save_det, save_img_label, evaluate_save_feat_by_ext_det,error_analysis,error_analysis_refined
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./for_debug',
    ...
    parser.add_argument('--infer_set', default='test', choices=['train', 'test', 'total'])
...
def main(args):
    ...
    #     param_dicts.append({"params": [p for n, p in model_without_ddp.named_parameters() if 'extra_rel' in n and p.requires_grad]})
